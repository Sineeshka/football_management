...
class PageTeam extends StatefulWidget {
  ...
  int index;
  PageTeam({required this.searchResults, required this.index});
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                          height: 35,
                          margin:
                              EdgeInsets.all(0), // Add some margin for spacing
                          //padding: EdgeInsets.all(16),
                          color: Colors.black,
                          child: Center(
                            child: Text(
                              'Team Name: ${widget.searchResults[widget.index]['name']}',
                              style: GoogleFonts.epilogue(
                                fontSize: 16,
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          'Created By : ${widget.searchResults[widget.index]['createdby']}',
                          style: GoogleFonts.epilogue(
                              fontSize: 16,
                        ...
                        Text(
                          'Description: ${widget.searchResults[widget.index]['description']}',
                          style: GoogleFonts.epilogue(
                            fontSize: 16,
                            fontWeight: FontWeight.normal,
                        ...
                        Text(
                          'Location : ${widget.searchResults[widget.index]['location']}',
                          style: GoogleFonts.epilogue(
                            fontSize: 16,
                            fontWeight: FontWeight.normal,
                            color: Color.fromARGB(255, 101, 75, 78),
